...
file_en = "DataAug/Data/art_30/data.en"
file_sp = "DataAug/Data/art_30/data.sparql"
...
shuffled_en, shuffled_sp = text_en[0:50], text_sp[0:50]
...
os.makedirs(os.path.dirname('DataAug/Data/art_30/Syntax-aware/dropped_data.en'), exist_ok=True)
f = open("DataAug/Data/art_30/Syntax-aware/dropped_data.en", "w+")
for i in range(len(en_sp_dropout)):
    f.write(en_sp_dropout[i][0]+"\n")

f.close()

os.makedirs(os.path.dirname('DataAug/Data/art_30/Syntax-aware/dropped_data.sparql'), exist_ok=True)
f = open("DataAug/Data/art_30/Syntax-aware/dropped_data.sparql", "w+")
for i in range(len(en_sp_dropout)):
...
os.makedirs(os.path.dirname('DataAug/Data/art_30/Syntax-aware/replaced_data.en'), exist_ok=True)
f = open("DataAug/Data/art_30/Syntax-aware/replaced_data.en", "w+")
for i in range(len(en_sp_replacement)):
    f.write(en_sp_replacement[i][0]+"\n")

f.close()

os.makedirs(os.path.dirname('DataAug/Data/art_30/Syntax-aware/replaced_data.sparql'), exist_ok=True)
f = open("DataAug/Data/art_30/Syntax-aware/replaced_data.sparql", "w+")
for i in range(len(en_sp_replacement)):
