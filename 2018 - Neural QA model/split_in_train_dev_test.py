...
if __name__ == '__main__':
    ...
    with open(sparql_file) as original_sparql, open(en_file) as original_en:
        ...
        with open('data/place_30/train.sparql', 'w') as train_sparql, open('data/place_30/train.en', 'w') as train_en, \
                open('data/place_30/dev.sparql', 'w') as dev_sparql, open('data/place_30/dev.en', 'w') as dev_en, \
                open('data/place_30/test.sparql', 'w') as test_sparql, open('data/place_30/test.en', 'w') as test_en:
