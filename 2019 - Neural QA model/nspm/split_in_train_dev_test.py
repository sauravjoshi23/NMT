...
if __name__ == '__main__':
    ...
    with io.open(sparql_file, encoding="utf-8") as original_sparql, io.open(en_file, encoding="utf-8") as original_en:
        ...
        with io.open(otp+'train.sparql', 'w', encoding="utf-8") as train_sparql, io.open(otp+'train.en', 'w', encoding="utf-8") as train_en, \
                io.open(otp+'dev.sparql', 'w', encoding="utf-8") as dev_sparql, io.open(otp+'dev.en', 'w', encoding="utf-8") as dev_en, \
                io.open(otp+'test.sparql', 'w', encoding="utf-8") as test_sparql, io.open(otp+'test.en', 'w', encoding="utf-8") as test_en:
