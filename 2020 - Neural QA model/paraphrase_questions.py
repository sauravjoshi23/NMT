...
def get_pretrained_model(zip_file_url):
    ...
    #     os.system(
    #         "curl --output ./t5_paraphraser.zip https://datascience-models-ramsri.s3.amazonaws.com/t5_paraphraser.zip")
    ...
    return 'ramsrigouthamg/t5_paraphraser'
